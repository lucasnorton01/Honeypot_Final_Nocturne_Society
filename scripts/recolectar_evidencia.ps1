...
.DESCRIPTION
    Crea evidencia/<Etiqueta>/, copia dentro del contenedor de n8n una copia de la base
    de datos y el script check_executions.js (sin tocar la base original), extrae el
    resultado, ejecuta pg_dump, copia cowrie.json y genera MANIFIESTO.sha256.txt.
