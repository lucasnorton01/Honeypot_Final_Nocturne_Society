...
# Credenciales válidas del honeypot (deben coincidir con cowrie/userdb.txt)
...
#  - SUCCESS_ATTEMPT: "user:pass" o vacío -> si está vacío, la sesión falla en autenticarse del todo
...
def fase_1_ataque() -> dict:
    ...
    if SUCCESS_ATTEMPT:
        ...
        log(f"  (sin credencial válida: la sesión falla en autenticarse del todo)")
