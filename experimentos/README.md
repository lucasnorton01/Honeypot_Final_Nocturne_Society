...
|---------|-----------|--------------|------|
| `report-generator-fixed.json` | Variante con Manual Trigger agregado; queries sin filtro temporal | Manual Trigger + Schedule (`0 8 * * *`) | Uso en ventanas de validación: NO DETERMINADO (ver Q4c) |
