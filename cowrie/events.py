...
class EventDispatcher:
    ...
    def __init__(
        ...
        # PATCH LOCAL: siempre formato con offset numerico (ej: -0300).
        # El codigo upstream emitia "Z" incluso con TZ local (bytecode stale),
        # asi que forzamos el formato %z para que la hora local sea honesta.
